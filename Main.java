...
public class Main {
    public static void main(String[] args) {
        ...
        Animal cat4 = new Cat("Кот", "рыжий", 10);
        ...
        Animal cat6 = new Cat("Кот", "рыжий", 10);
        cat6.voice();

        //Создать набор бассейнов и заставить животных проплыть по ним и вывести время на заплыв

        Cat catCompetitor1 = new Cat("Кот", "рыжий", 10);
        catCompetitor1.setSwimmingSpeed(10);
        Wolf wolfCompetitor1 = new Wolf("Волк", "серый", 12);
        wolfCompetitor1.setSwimmingSpeed(12);
        Dog turtleCompetitor = new Dog("Пёс", "чёрный", 8);
        turtleCompetitor.setSwimmingSpeed(15);
        Ferret ferretCompetitor = new Ferret("Хорёк", "чёрный", 6);
        ferretCompetitor.setSwimmingSpeed(20);

        Pool[] pools = {new Pool(15), new Pool(20), new Pool(35), new Pool(40)};
        ...
        for (Pool pool : pools) {
            ...
            pool.getTimeToOvercomePool(ferretCompetitor);
        }
